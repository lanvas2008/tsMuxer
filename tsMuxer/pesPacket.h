...
struct PESPacket {
  ...
  */
  ...
  //The flag is set as necessary to indicate that extension flags are set in the
  PES header. Its use includes support of private data.
  //1 - Field is present.
  ...
  //Indicates the presence of an 8 bit field describing the DSM (Digital Storage
