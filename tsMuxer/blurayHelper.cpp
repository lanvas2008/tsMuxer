...
uint8_t bdIndexData[] = {
    0x49, 0x4e, 0x44, 0x58, 0x30, 0x32, 0x30, 0x30, 0x00, 0x00, 0x00, 0x4e,
    ...
    ,
    ...
    0x30, 0x30, 0x30, 0x30, 0x30, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

uint8_t bdMovieObjectData[] = {
    0x4D, 0x4F, 0x42, 0x4A, 0x30, 0x31, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF6, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x03, 0x80, 0x00, 0x00, 0x05, 0x50, 0x00, 0x00, 0x01, 0x00, 0x00,
    0x00, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x50, 0x40, 0x00, 0x01, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, 0x40,  // here 5040
    ,
...
bool BlurayHelper::open(const string& dst, DiskType dt, int64_t diskSize,
                        int extraISOBlocks) {
...
bool BlurayHelper::writeBluRayFiles(bool usedBlackPL, int mplsNum, int blankNum,
                                    bool stereoMode) {
   ...
   if (!file->open((prefix + "BDMV/index.bdmv").c_str(),
                   AbstractOutputStream::ofWrite)) {
      delete file;
      return false;
   }
   ...
   bdIndexData[0x2c] =
       stereoMode
           ? 0x60
           : 0;  // set initial_output_mode_preference and SS_content_exist_flag
   ...
   if (usedBlackPL) {
      ...
      memcpy(emptyCommand, "\x50\x40\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00",
             12);
   ...
   *mplsOff = my_htonl(mplsNum);
   ...
   if (!file->open((prefix + "BDMV/BACKUP/index.bdmv").c_str(),
                   File::ofWrite)) {
      delete file;
      return false;
   }
   ...
   if (!file->open((prefix + "BDMV/BACKUP/MovieObject.bdmv").c_str(),
                   File::ofWrite)) {
      delete file;
      return false;
   }
...
bool BlurayHelper::createCLPIFile(TSMuxer* muxer, int clpiNum, bool doLog) {
   ...
   if (clpiParser.isDependStream)
      clpiParser.application_type =
          8;  // Sub TS for a sub-path of MPEG-4 MVC Dependent view
   else
   ...
   for (PIDListMap::const_iterator itr = pidList.begin(); itr != pidList.end();
      ...
      clpiParser.m_streamInfo.insert(
          make_pair(streamInfo.streamPID, streamInfo));
   }
   ...
   for (unsigned i = 0; i < muxer->splitFileCnt(); i++) {
      ...
      // clpiParser.TS_recording_rate = (packetCount[i] * 192) / avDuration; //
      // avarage bitrate
      ...
      string dstDir = string("BDMV") + getDirSeparator() + string("CLIPINF") +
                      getDirSeparator();
      string clipName = extractFileName(muxer->getFileNameByIdx(i));
      if (!file->open((prefix + dstDir + clipName + string(".clpi")).c_str(),
                      File::ofWrite)) {
         delete[] clpiBuffer;
         delete file;
         return false;
      ...
      dstDir = string("BDMV") + getDirSeparator() + string("BACKUP") +
               getDirSeparator() + string("CLIPINF") + getDirSeparator();
      if (!file->open((prefix + dstDir + clipName + string(".clpi")).c_str(),
                      File::ofWrite)) {
         delete[] clpiBuffer;
         delete file;
...
const PMTStreamInfo* streamByIndex(int index, const PIDListMap& pidList) {
   for (PIDListMap::const_iterator itr = pidList.begin(); itr != pidList.end();
      ...
      if (stream.m_codecReader->getStreamIndex() == index) return &stream;
   }
   return 0;
}
...
bool BlurayHelper::createMPLSFile(TSMuxer* mainMuxer, TSMuxer* subMuxer,
                                  int autoChapterLen,
                                  vector<double> customChapters, DiskType dt,
                                  int mplsOffset, bool isMvcBaseViewR) {
   ...
   if (customChapters.size() == 0) {
      ...
      for (int i = 0; i < customChapters.size(); i++) {
         ...
         if (mark >= 0 && mark <= (mplsParser.OUT_time - mplsParser.IN_time))
            mplsParser.m_marks.push_back(
                PlayListMark(-1, mark + mplsParser.IN_time));
      }
   }
   mplsParser.PlayItem_random_access_flag = false;
   PIDListMap pidList = mainMuxer->getPidList();
   PIDListMap pidListMVC;
   if (subMuxer) pidListMVC = subMuxer->getPidList();
   ...
   for (PIDListMap::const_iterator itr = pidList.begin(); itr != pidList.end();
      ...
      PGSStreamReader* pgStream =
          dynamic_cast<PGSStreamReader*>(itr->second.m_codecReader);
      if (pgStream) {
         ...
         if (info.isSSPG) {
            ...
            const PMTStreamInfo* left =
                streamByIndex(pgStream->leftEyeSubStreamIdx, pidList);
            if (!left) {
            ...
            if (left) {
               ...
               if (isSecondary) info.leftEye->type = 2;  // ref to subclip
            }

            isSecondary = false;
            const PMTStreamInfo* right =
                streamByIndex(pgStream->rightEyeSubStreamIdx, pidList);
            if (!right) {
               right =
                   streamByIndex(pgStream->rightEyeSubStreamIdx, pidListMVC);
               isSecondary = true;
            }
            if (right) {
               info.rightEye = new MPLSStreamInfo(*right);
               if (isSecondary) info.rightEye->type = 2;  // ref to subclip
            }
         }
      }
   }
   if (subMuxer) {
      ...
      for (PIDListMap::const_iterator itr = pidListMVC.begin();
           itr != pidListMVC.end(); ++itr) {
         MPLSStreamInfo data(itr->second);
         data.type = 2;  // Identify an elementary stream of the Clip used by a
                         // SubPath with SubPath_type set to 2,3,4,5,6,8 or 9
   ...
   string dstDir = string("BDMV") + getDirSeparator() + string("PLAYLIST") +
                   getDirSeparator();
   if (!file->open(
           (prefix + dstDir + strPadLeft(int32ToStr(mplsOffset), 5, '0') +
            string(".mpls"))
               .c_str(),
           File::ofWrite))
      return false;
   ...
   dstDir = string("BDMV") + getDirSeparator() + string("BACKUP") +
            getDirSeparator() + string("PLAYLIST") + getDirSeparator();
   if (!file->open(
           (prefix + dstDir + strPadLeft(int32ToStr(mplsOffset), 5, '0') +
            string(".mpls"))
               .c_str(),
...
string BlurayHelper::m2tsFileName(int num) {
   ...
   return prefix + string("BDMV") + separator + string("STREAM") + separator +
          strPadLeft(int32ToStr(num), 5, '0') + string(".m2ts");
}
...
string BlurayHelper::ssifFileName(int num) {
   ...
   char separator = m_isoWriter ? '/' : getDirSeparator();
   return prefix + string("BDMV") + separator + string("STREAM") + separator +
          string("SSIF") + separator + strPadLeft(int32ToStr(num), 5, '0') +
          string(".ssif");
}
...
void BlurayHelper::setVolumeLabel(const std::string& label) {
   if (m_isoWriter) m_isoWriter->setVolumeLabel(unquoteStr(label));
}
