...
class MPEGStreamReader : public AbstractStreamReader {
  ...
  protected:
   ...
   void updateFPS(void* curNALUnit, uint8_t* buff, uint8_t* nextNal,
                  int oldSPSLen);
   virtual void updateStreamFps(void* nalUnit, uint8_t* buff, uint8_t* nextNal,
                                int oldSpsLen) = 0;
   virtual void updateStreamAR(void* nalUnit, uint8_t* buff, uint8_t* nextNal,
                               int oldSpsLen){};
  ...
  protected:
   ...
   // static int bufFromNAL(const uint8_t* buff, const uint8_t* bufEnd, bool
   // longCodesAllowed);
