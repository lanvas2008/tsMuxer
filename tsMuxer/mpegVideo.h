...
static const double frame_rates[] = {0.0,  23.97602397602397, 24.0,
                                     25.0, 29.97002997002997, 30,
...
class MPEGRawDataHeader : public MPEGHeader {
  public:
   ...
   virtual bool addRawData(uint8_t* buffer, int len, bool headerIncluded,
                           bool isHeader);
...
const static char* frameTypeDescr[5] = {"FORBIDDEN", "I_FRAME", "P_FRAME",
                                        "B_FRAME", "D_FRAME"};
...
class MPEGPictureHeader : public MPEGRawDataHeader {
  public:
   ...
   bool addRawData(uint8_t* buffer, int len, bool headerIncluded,
                   bool isHeader);
   void buildHeader();
