...
class AbstractReader {
 public:
  ...
  virtual bool openStream(uint32_t readerID, const char* streamName,
                          int pid = 0, const CodecInfo* codecInfo = 0) = 0;
  ...
  virtual void setPreReadThreshold(uint32_t nPreReadThreshold) {
    m_prereadThreshold = nPreReadThreshold;
  }
