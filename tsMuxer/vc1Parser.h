...
const AVRational ff_vc1_pixel_aspect[16] = {
    AVRational(0, 1),   AVRational(1, 1),    AVRational(12, 11),
    AVRational(10, 11), AVRational(16, 11),  AVRational(40, 33),
    AVRational(24, 11), AVRational(20, 11),  AVRational(32, 11),
    AVRational(80, 33), AVRational(18, 11),  AVRational(15, 11),
    AVRational(64, 33), AVRational(160, 99), AVRational(0, 1),
    AVRational(0, 1)};
...
class VC1Unit {
 public:
  ...
  inline static bool isMarker(uint8_t* ptr) {
    return ptr[0] == ptr[1] == 0 && ptr[2] == 1;
  }
  ...
  inline int vc1_unescape_buffer(uint8_t* src, int size) {
    if (m_nalBuffer != 0) delete m_nalBuffer;
...
class VC1Frame : public VC1Unit {
 public:
  ...
  int rff;
  int rptfrmBitPos;
  int decode_frame_direct(const VC1SequenceHeader& sequenceHdr, uint8_t* buffer,
                          uint8_t* end);
