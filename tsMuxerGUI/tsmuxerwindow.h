...
class TsMuxerWindow : public QWidget {
 ...
 private:
  struct MPLSFileInfo {
    MPLSFileInfo(const QString& _name, double _duration)
  ...
  void doAppendInt(const QString& fileName, const QString& parentFileName,
                   double duration, bool doublePrefix, MplsType mplsRole);
